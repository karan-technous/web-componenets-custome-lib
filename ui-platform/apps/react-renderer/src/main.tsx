...
declare global {
  interface Window {
    BridgeReact: typeof React;
    BridgeReactWrappers: typeof ReactWrappers & { noop?: () => void };
  }
}
        ...
        <main className="page">
          <section className="canvas">
            <div className="controls">
              {runtimeState.error ? (
                <div className="text-sm text-rose-400 whitespace-pre-wrap">
                  {runtimeState.error}
                </div>
              ) : StoryComponent ? (
                <StoryComponent />
